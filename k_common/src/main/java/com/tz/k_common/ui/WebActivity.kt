...
import com.tz.k_common.R
import com.tz.k_common.base.BaseActivity
import com.tz.k_common.databinding.ActivityWebBinding
import com.tz.k_common.utils.ConstConfig

@Route(path = ConstConfig.PATH_WEB)
class WebActivity : BaseActivity<ActivityWebBinding>() {
    ...
    override fun init() {
        ...
        val t = intent.getStringExtra(ConstConfig.WEB_TITLE)
        val l = intent.getStringExtra(ConstConfig.WEB_LINK).toString()
