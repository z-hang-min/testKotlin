...
import com.tz.k_project.databinding.FragmentProjectChildBinding
import com.tz.k_project.ui.adapter.ProItemClickListener
import com.tz.k_project.ui.adapter.ProRVAdapter
...
class ProjectChildFragment : BaseVMFragment<FragmentProjectChildBinding>() {
    ...
    override fun init() {
        ...
        mBind.srlPro.setColorSchemeResources(com.tz.k_common.R.color.theme_color)
